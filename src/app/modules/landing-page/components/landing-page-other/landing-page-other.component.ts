...
@Component({
  selector: 'app-landing-page-other',
  templateUrl: './landing-page-other.component.html',
  styleUrls: ['./landing-page-other.component.css']
})
export class LandingPageOtherComponent implements OnInit, OnDestroy {
