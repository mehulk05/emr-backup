...
export class QuestionarieService {
  ...
  getQuestionnaireConditions(questionnaireId: number) {
    const apiUrl = `/api/questionnaire/${questionnaireId}/conditions`;
    return this.apiService.get(
      apiUrl,
      '',
      false,
  ...
  saveQuestionnaireCondition(questionnaireId: number, formData: any) {
    const apiUrl = `/api/questionnaire/${questionnaireId}/conditions`;
    return this.apiService.post(
      apiUrl,
      formData,
  ...
  deleteQuestionnaireCondition(
    questionnaireId: number,
    questionnaireConditionId: any
  ) {
    const apiUrl = `/api/questionnaire/${questionnaireId}/conditions/${questionnaireConditionId}`;
    return this.apiService.delete(
      apiUrl,
      '',
      false,
  ...
  getPatientQuestionnaireSubmissionList(questionnaireId: number) {
    const apiurl = `/api/patient/questionnaire/${questionnaireId}/questionnaire-submissions`;
    return this.apiService.get(
      apiurl,
      '',
      false,
  ...
  getPatientQuestionAnswers(questionnaireSubmissionId: number) {
    const apiUrl = `/api/patient/questionnaire/questionnaire-submissions/${questionnaireSubmissionId}`;
    return this.apiService.get(
      apiUrl,
      '',
      false,
