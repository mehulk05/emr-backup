...
@Component({
  selector: 'app-consent-others',
  templateUrl: './consent-others.component.html',
  styleUrls: ['./consent-others.component.css']
})
export class ConsentOthersComponent implements OnInit {
  ...
  loadTemplatList() {
    this.consentService.getAllOtherConsentListOptimized().then(
      (data: any) => {
        this.rowData = data;
      },
      () => {
