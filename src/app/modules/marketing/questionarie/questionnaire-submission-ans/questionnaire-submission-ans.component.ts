...
@Component({
  selector: 'app-questionnaire-submission-ans',
  templateUrl: './questionnaire-submission-ans.component.html',
  styleUrls: ['./questionnaire-submission-ans.component.css']
})
export class QuestionnaireSubmissionAnsComponent implements OnInit {
